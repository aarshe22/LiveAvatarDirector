...
def normalize_portrait(source: Path, target: Path, size: tuple[int, int], mode: str = "smart_blur", fill: str = "#18181b") -> dict:
    width, height = size
    ...
    return {"original_dimensions": list(original), "target_dimensions": [width, height], "mode": mode,
